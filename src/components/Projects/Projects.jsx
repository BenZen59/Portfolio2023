...
function Projects() {
    return (<div className='w-full'>
            ...
            <div className='flex flex-wrap justify-center items-center font-mono'>
                {projets.map((projet) => (<div
                        className='bg-zinc-800 px-20 py-20 rounded-lg border-solid border-2 border-gray-500 m-[10px] w-[783px] max-md:w-[392px] max-md:h-auto h-[344px]'>
                        ...
                        <div className='flex max-md:flex-wrap '>
                            ...
                            {projet.techno.map((tech, index) => (<div
