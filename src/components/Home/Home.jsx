        ...
        <p className="ml-[50px] mt-[50px] max-md:ml-[15px]">
          ...
          <div className="text-[18px]">
            ...
            <span className="text-bold text-blue-500">
              Titre Profesionnel Concepteur Développeur d'Application
            </span>
            , je suis actuellement à la recherche de mon premier emploi sur{" "}
            <span className="text-bold text-blue-500">Lille</span>, et je suis
            particulièrement motivé à l’idée de débuter ma carrière.
            <br />
